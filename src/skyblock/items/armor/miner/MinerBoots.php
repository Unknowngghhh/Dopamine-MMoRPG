...
class MinerBoots extends SkyblockArmor implements ItemComponents{
	...
	public function __construct(ItemIdentifier $identifier, string $name = "Unknown"){
		...
		$this->initComponent("miner_boots", new CreativeInventoryInfo(CreativeInventoryInfo::CATEGORY_EQUIPMENT, CreativeInventoryInfo::GROUP_BOOTS));
