...
class MinerLeggings extends SkyblockArmor implements ItemComponents{
	...
	public function __construct(ItemIdentifier $identifier, string $name = "Unknown"){
		...
		$this->initComponent("miner_leggings", new CreativeInventoryInfo(CreativeInventoryInfo::CATEGORY_EQUIPMENT, CreativeInventoryInfo::GROUP_LEGGINGS));
