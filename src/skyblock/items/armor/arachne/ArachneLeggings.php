...
class ArachneLeggings extends SkyblockArmor implements ItemComponents {
	...
	public function __construct(
		...
		parent::__construct(
			$identifier,
			$name,
			new SkyBlockArmorInfo(4, ArmorInventory::SLOT_LEGS)
		);
	...
	public function onTransaction(
		...
		if (
			$itemClickedWith instanceof ArachneLeggings &&
			$itemClicked instanceof ArachneLeggings
		) {
			$stacked = $itemClicked
				->getNamedTag()
