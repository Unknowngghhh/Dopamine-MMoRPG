...
class ArachneHelmet extends SkyblockArmor implements ItemComponents {
	...
	public function __construct(
		...
		parent::__construct(
			$identifier,
			$name,
			new SkyBlockArmorInfo(4, ArmorInventory::SLOT_HEAD)
		);
	...
	public function onTransaction(
		...
		if (
			$itemClickedWith instanceof ArachneHelmet &&
			$itemClicked instanceof ArachneHelmet
		) {
			$stacked = $itemClicked
				->getNamedTag()
